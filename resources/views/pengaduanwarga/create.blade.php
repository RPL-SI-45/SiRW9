...
@section('content')
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/admin/pengaduanwarga/create">Home</a></li>
    ...
    <div class="card">
        <div class="card-body">
              <h5 class="card-title">Masukkan Aduan warga</h5>
                <form id='pengaduanwargaForm' class="row g-3" action="/admin/pengaduanwarga/create" method="GET">
                    @csrf
                    <div class="mb-3">
                        <label>Aduan</label>
